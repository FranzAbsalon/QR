...
@section('content')
    ...
    <script type="text/javascript">
        ...
        function success(result) {
            document.getElementById('result').innerHTML = `<h2>Success</h2><p>Your QR Code is<button class="btn btn-success" id="myButton" >${result}</button></p></form>`;
            // scanner.clear();
        ...
        function copyText() {
            ...
            navigator.clipboard.writeText(text).then(function() {
                swal({
                    ...
                    text: "Paste it on the input box at the right side of your screen",
                    icon: "info",
                    button: "Ok",
